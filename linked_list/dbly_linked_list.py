...
1. has internal class Node which has three attributes 
2. the class constructor initiates a header node and a trailer node 
and connects them. count of nodes is set to 0. 
3. the class has 2 accessors: len() and is_empty()
4. the class has two updators: intert_between and del
"""
