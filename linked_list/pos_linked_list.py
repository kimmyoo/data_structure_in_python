...
# some tests on positional linked list
pos_linked_li = PositionalLinkedList()

pos1 = pos_linked_li.add_first('research')
pos2 = pos_linked_li.add_last('you')
pos_linked_li.replace(pos1, 'think of')
pos3 = pos_linked_li.add_after(pos2, 'post')
node_to_delete = pos_linked_li.add_before(pos3, 'when I')

for element in pos_linked_li:
    print (element)

pos_linked_li.delete(node_to_delete)
